...
// update self-updates the gdrive binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/gdrive-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update gdrive to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "gdrive-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "gdrive")
...
func streamCmd(cmd *cobra.Command, dir, name string, cmdArgs ...string) error {
